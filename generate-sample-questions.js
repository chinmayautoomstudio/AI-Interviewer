// Script to generate sample questions for the database
// Run this to populate the database with sample questions for testing
...
async function generateSampleQuestions() {
  try {
    console.log('🚀 Starting to generate sample questions...');
    ...
    console.log('📋 Found job descriptions:', jobDescriptions);

    // Use the first job description ID for all questions
    const jobDescriptionId = jobDescriptions[0].id;
    console.log('🎯 Using job description:', jobDescriptions[0].title, '(ID:', jobDescriptionId, ')');
    ...
    console.log('✅ Successfully generated', data.length, 'sample questions!');
    ...
    console.log('\n🎉 Sample questions generated successfully!');
