...
-- This script inserts questions for the existing Web Developer Intern job description
...
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
...
-- Additional HTML/CSS Questions (15 more)
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'Which CSS property is most effective for creating a responsive navigation menu that collapses on mobile?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "display: none; @media (max-width: 768px) { display: block; }"},
    {"option": "B", "text": "flex-direction: column; @media (max-width: 768px) { flex-direction: row; }"},
    {"option": "C", "text": "grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));"},
    {"option": "D", "text": "position: absolute; @media (max-width: 768px) { position: relative; }"}
  ]',
  'A',
  'Using display: none with media queries is the most effective way to create responsive navigation that hides/shows based on screen size.',
  4,
  75,
  ARRAY['CSS', 'Responsive', 'Navigation', 'Media Queries'],
  (SELECT id FROM question_topics WHERE name = 'Web Development' LIMIT 1),
  'ai',
  'approved',
  true,
...
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'What is the most efficient way to implement CSS animations that perform well on mobile devices?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "Use transform and opacity properties"},
    {"option": "B", "text": "Use width and height properties"},
    {"option": "C", "text": "Use margin and padding properties"},
    {"option": "D", "text": "Use background-color and color properties"}
  ]',
  'A',
  'Transform and opacity properties are GPU-accelerated and don''t trigger layout recalculations, making them most efficient for mobile animations.',
  4,
  75,
  ARRAY['CSS', 'Animations', 'Performance', 'Mobile'],
  (SELECT id FROM question_topics WHERE name = 'Web Development' LIMIT 1),
  'ai',
  'approved',
  true,
...
-- Additional JavaScript Questions (20 more)
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'What is the output of this JavaScript code?\\n\\nconst obj = { a: 1, b: 2 };\\nconst { a, ...rest } = obj;\\nconsole.log(rest);',
  ...
  '[
    {"option": "A", "text": "{ a: 1 }"},
    {"option": "B", "text": "{ b: 2 }"},
    {"option": "C", "text": "{ a: 1, b: 2 }"},
    {"option": "D", "text": "undefined"}
  ]',
  'B',
  'The rest operator (...) collects all remaining properties after destructuring. Since ''a'' is destructured separately, ''rest'' contains only ''b''.',
  4,
  90,
  ARRAY['JavaScript', 'Destructuring', 'Rest Operator', 'ES6'],
  (SELECT id FROM question_topics WHERE name = 'Programming Languages' LIMIT 1),
  'ai',
  'approved',
  true,
...
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'Which JavaScript method is most appropriate for handling errors in async functions?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "try-catch with async/await"},
    {"option": "B", "text": ".catch() with Promises"},
    {"option": "C", "text": "window.onerror"},
    {"option": "D", "text": "All of the above"}
  ]',
  'D',
  'All methods are valid: try-catch for async/await, .catch() for Promises, and window.onerror for global error handling.',
  4,
  75,
  ARRAY['JavaScript', 'Error Handling', 'Async', 'Promises'],
  (SELECT id FROM question_topics WHERE name = 'Programming Languages' LIMIT 1),
  'ai',
  'approved',
  true,
...
-- Additional React Questions (15 more)
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'What is the most efficient way to prevent unnecessary re-renders in React functional components?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "Use React.memo() with proper comparison function"},
    {"option": "B", "text": "Use useMemo() for expensive calculations"},
    {"option": "C", "text": "Use useCallback() for event handlers"},
    {"option": "D", "text": "All of the above"}
  ]',
  'D',
  'All three techniques work together: React.memo() prevents component re-renders, useMemo() prevents expensive recalculations, and useCallback() prevents function recreation.',
  4,
  75,
  ARRAY['React', 'Performance', 'Optimization', 'Re-renders'],
  (SELECT id FROM question_topics WHERE name = 'Web Development' LIMIT 1),
...
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'Which React pattern is most effective for managing complex form state with validation?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "useReducer with custom validation logic"},
    {"option": "B", "text": "Multiple useState hooks"},
    {"option": "C", "text": "useForm library (like react-hook-form)"},
    {"option": "D", "text": "All of the above"}
  ]',
  'D',
  'All approaches are valid depending on complexity: useReducer for complex state logic, useState for simple forms, and useForm libraries for advanced features.',
  4,
  75,
  ARRAY['React', 'Forms', 'Validation', 'State Management'],
  (SELECT id FROM question_topics WHERE name = 'Web Development' LIMIT 1),
  'ai',
  'approved',
  true,
...
-- Additional Node.js Questions (10 more)
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'What is the most secure way to handle user input validation in Node.js Express applications?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "Use express-validator middleware"},
    {"option": "B", "text": "Manual validation with if statements"},
    {"option": "C", "text": "Client-side validation only"},
    {"option": "D", "text": "No validation needed"}
  ]',
  'A',
  'express-validator provides comprehensive server-side validation with sanitization, making it the most secure approach for handling user input.',
  4,
  75,
  ARRAY['Node.js', 'Express', 'Validation', 'Security'],
  (SELECT id FROM question_topics WHERE name = 'Web Development' LIMIT 1),
  'ai',
  'approved',
  true,
...
-- Additional Database Questions (5 more)
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'What is the most efficient way to handle database connections in Node.js applications?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "Connection pooling"},
    {"option": "B", "text": "Create new connection for each request"},
    {"option": "C", "text": "Single global connection"},
    {"option": "D", "text": "No connection management"}
  ]',
  'A',
  'Connection pooling reuses database connections efficiently, reducing overhead and improving performance compared to creating new connections for each request.',
  4,
  75,
  ARRAY['Database', 'Node.js', 'Connection Pooling', 'Performance'],
  (SELECT id FROM question_topics WHERE name = 'Database Management' LIMIT 1),
  'ai',
  'approved',
  true,
...
-- Additional Security Questions (5 more)
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'What is the most effective way to prevent SQL injection attacks in web applications?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "Use parameterized queries/prepared statements"},
    {"option": "B", "text": "Input validation only"},
    {"option": "C", "text": "Escape special characters"},
    {"option": "D", "text": "All of the above"}
  ]',
  'D',
  'All methods work together: parameterized queries prevent injection, input validation catches malicious input, and escaping provides additional protection.',
  4,
  75,
  ARRAY['Security', 'SQL Injection', 'Database', 'Prevention'],
  (SELECT id FROM question_topics WHERE name = 'Security' LIMIT 1),
  'ai',
  'approved',
  true,
...
-- Additional Testing Questions (5 more)
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'Which testing approach is most effective for React component testing?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "Unit tests with Jest and React Testing Library"},
    {"option": "B", "text": "Integration tests with Cypress"},
    {"option": "C", "text": "Manual testing only"},
    {"option": "D", "text": "All of the above"}
  ]',
  'D',
  'A comprehensive testing strategy includes unit tests for components, integration tests for user flows, and manual testing for edge cases.',
  4,
  75,
  ARRAY['Testing', 'React', 'Jest', 'Quality Assurance'],
  (SELECT id FROM question_topics WHERE name = 'Web Development' LIMIT 1),
  'ai',
  'approved',
  true,
...
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'What is the most effective way to optimize web application performance?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "Code splitting and lazy loading"},
    {"option": "B", "text": "Image optimization and compression"},
    {"option": "C", "text": "Caching strategies"},
    {"option": "D", "text": "All of the above"}
  ]',
  'D',
  'Performance optimization requires multiple strategies: code splitting reduces bundle size, image optimization improves loading, and caching reduces server requests.',
  4,
  75,
  ARRAY['Performance', 'Optimization', 'Web Development', 'Best Practices'],
  (SELECT id FROM question_topics WHERE name = 'Web Development' LIMIT 1),
  'ai',
  'approved',
  true,
...
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'Which CSS property is most effective for creating a responsive card layout that adapts to different screen sizes?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));"},
    {"option": "B", "text": "display: flex; flex-wrap: wrap; justify-content: space-between;"},
    {"option": "C", "text": "display: block; width: 100%;"},
    {"option": "D", "text": "position: absolute; top: 0; left: 0;"}
  ]',
  'A',
  'CSS Grid with auto-fit and minmax creates responsive cards that automatically adjust the number of columns based on available space.',
  4,
  75,
  ARRAY['CSS', 'Grid', 'Responsive', 'Cards'],
  (SELECT id FROM question_topics WHERE name = 'Web Development' LIMIT 1),
  'ai',
  'approved',
  true,
...
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'What is the output of this JavaScript code?\\n\\nconst arr = [1, 2, 3, 4, 5];\\nconst doubled = arr.map(x => x * 2).filter(x => x > 5);\\nconsole.log(doubled);',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "[6, 8, 10]"},
    {"option": "B", "text": "[2, 4, 6, 8, 10]"},
    {"option": "C", "text": "[1, 2, 3, 4, 5]"},
    {"option": "D", "text": "[3, 4, 5]"}
  ]',
  'A',
  'The map function doubles each element [2, 4, 6, 8, 10], then filter keeps only elements > 5, resulting in [6, 8, 10].',
  4,
  90,
  ARRAY['JavaScript', 'Array Methods', 'Map', 'Filter'],
  (SELECT id FROM question_topics WHERE name = 'Programming Languages' LIMIT 1),
  'ai',
  'approved',
  true,
...
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'Which React pattern is most effective for sharing logic between multiple components?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "Custom hooks"},
    {"option": "B", "text": "Higher-order components (HOCs)"},
    {"option": "C", "text": "Render props"},
    {"option": "D", "text": "All of the above"}
  ]',
  'D',
  'All patterns are valid: custom hooks for modern React, HOCs for class components, and render props for flexible composition.',
  4,
  75,
  ARRAY['React', 'Custom Hooks', 'HOCs', 'Render Props'],
  (SELECT id FROM question_topics WHERE name = 'Web Development' LIMIT 1),
  'ai',
  'approved',
  true,
...
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'What is the most efficient way to handle file uploads in Node.js Express applications?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "Use multer middleware with proper validation"},
    {"option": "B", "text": "Handle raw data streams manually"},
    {"option": "C", "text": "Use only client-side validation"},
    {"option": "D", "text": "Store files in memory"}
  ]',
  'A',
  'Multer middleware provides efficient file upload handling with validation, size limits, and proper file management.',
  4,
  75,
  ARRAY['Node.js', 'Express', 'File Upload', 'Multer'],
  (SELECT id FROM question_topics WHERE name = 'Web Development' LIMIT 1),
  'ai',
  'approved',
  true,
...
(
  gen_random_uuid(),
  'a16ed2c5-8f81-4692-bd34-994b88f32bdb',
  'What is the most effective way to prevent Cross-Site Scripting (XSS) attacks?',
  'mcq',
  'technical',
  'hard',
  '[
    {"option": "A", "text": "Input validation, output encoding, and Content Security Policy"},
    {"option": "B", "text": "Client-side validation only"},
    {"option": "C", "text": "Server-side validation only"},
    {"option": "D", "text": "No special measures needed"}
  ]',
  'A',
  'XSS prevention requires multiple layers: input validation, output encoding, and CSP headers to block malicious scripts.',
  4,
  75,
  ARRAY['Security', 'XSS', 'Prevention', 'Web Security'],
  (SELECT id FROM question_topics WHERE name = 'Security' LIMIT 1),
  'ai',
  'approved',
  true,
